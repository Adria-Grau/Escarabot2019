...
int avoidanceLeft(NewPing sonar)
{
  //Calcular distància i, si la distància és massa petita, donar marxar endarrere
...
int avoidanceRight(NewPing sonar)
{
  //Calcular distància i, si la distància és massa petita, donar marxar endarrere
  int distance = sonar.ping_cm();
  if(distance <= 6)
